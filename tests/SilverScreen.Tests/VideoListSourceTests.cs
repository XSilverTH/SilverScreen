...
public sealed class VideoListSourceTests
{
    ...
    {
        var state = new ViewModels.SearchViewState([], "Search complete.", false, false, false, true);
    ...
    {
        var state = new ViewModels.SearchViewState([], "Custom empty message", false, false, false, true);
        var presentation = SearchVideoListSource.MapState(state);
    ...
    {
        var state = new ViewModels.SearchViewState([], "Search failed.", false, false, false, false);
        var presentation = SearchVideoListSource.MapState(state);
    ...
    {
        var state = new ViewModels.SearchViewState([], "Search could not be completed.", false, false, false, false);
        var presentation = SearchVideoListSource.MapState(state);
    ...
    {
        var state = new ViewModels.SearchViewState([], "Searching YouTube for “dotnet”…", true, false, false, true);
        var presentation = SearchVideoListSource.MapState(state);
    ...
    {
        var state = new ViewModels.HistoryViewState([], "", false, false,
    ...
    {
        var state = new ViewModels.HistoryViewState([], "", false, true,
    ...
    {
        var state = new ViewModels.ChannelViewState("https://www.youtube.com/@example", "Example", null, null, null,
